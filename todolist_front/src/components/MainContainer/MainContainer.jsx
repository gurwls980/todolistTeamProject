            ...
            <ReactModal
                ...
                <div>
                    ...
                    <div css={containerBox}>
                        <h1 class='listTitle'>todolist</h1>
                        <div css={s.registerBox}>
                            <input type="text" css={s.submitBox} name='content' value={registerTodo.content}
                                onChange={handleRegisterInputChange} onKeyDown={handleEnter}
                                placeholder="To Do - List를 입력해주세요." />
                            <input type='month' name='registerDate' css={s.registerInput} onChange={handleInputChange} />
                        </div>
                                        ...
                                        <tbody>
                                            {
                                                todoList.map(todo =>
                                                    <tr key={todo.todoId}>
                                                        <input css={todoCheck} type="checkbox" checked={!!todo.checkStatus} onChange={() => handleCheckedChange(todo.todoId)} value={todo.checkStatus} />
                                                        <td css={s.content}>{todo.content}</td>
                                                        <td css={s.date}>{todo.registerDate}</td>
                                        ...
                                        <tbody>

                                            {
                                                todoList.filter(todo => !todo.checkStatus).map(todo =>
                                                    <tr key={todo.todoId}>
                                                        <input css={s.todoCheck} type="checkbox" checked={todo.checkStatus} onChange={() => handleCheckedChange(todo.todoId)} />
                                                        <td css={s.content}>{todo.content}</td>
                                                        <td css={s.date}>{todo.registerDate}</td>
                                    ...
                                    <table>
                                        ...
                                        <tbody>

                                            {
                                                todoList.filter(todo => !!todo.checkStatus).map(todo =>
                                                    <tr key={todo.todoId}>
                                                        <input type="checkbox" css={s.todoCheck} checked={!!todo.checkStatus} onChange={() => handleCheckedChange(todo.todoId)} />
                                                        <td css={s.content}>{todo.content}</td>
                                                        <td css={s.date}>{todo.registerDate}</td>
                                                        {/* <td><button onClick={() => handleUpdateTodoClick(todo.todoId)}><TfiPencilAlt /></button></td> */}
                                                        <td><button onClick={() => handleDeleteListClick(todo.todoId)}><VscTrash /></button></td>
